!function() {
    ...
    function pu(n, t) {
        ...
        for (il = [], ol = new Array(n.length), al = new lu, ll = new lu;;)
            if (u = cl, i && (!u || i.y < u.y || i.y === u.y && i.x < u.x))
                (i.x !== r || i.y !== e) && (ol[i.i] = new We(i), Xe(i), r = i.x, e = i.y), i = n.pop();
            else {
                if (!u)
                    break;
                $e(u.arc)
            ...
            if (o = s[e], o.x == r[0]) {
                if (o.i)
                    if (null == l[o.i + 1])
                        ...
                        for (l[o.i - 1] += o.x + l[o.i + 1], l.splice(o.i, 2), u = e + 1; i > u; ++u)
                            s[u].i -= 2;
                else if (null == l[o.i + 1])
                    l[o.i] = o.x;
                else
                    for (l[o.i] = o.x + l[o.i + 1], l.splice(o.i + 1, 1), u = e + 1; i > u; ++u)
                        s[u].i--;
                s.splice(e, 1), i--, e--
            } else
    ...
    La.select = function(n) {
        ...
        for (var u = -1, i = this.length; ++u < i;)
            for (var o = this[u], a = -1, c = o.length; ++a < c;)
                (r = o[a]) && (e.push(t = ca(n.call(r, r.__data__, a, u))), t.parentNode = r);
        return _(e)
    };
    var qa = {
    ...
    oa.selection.enter = U, oa.selection.enter.prototype = Ta, Ta.append = La.append, Ta.empty = La.empty, Ta.node = La.node, Ta.call = La.call, Ta.size = La.size, Ta.select = function(n) {
        for (var t, r, e, u, i, o = [], a = -1, c = this.length; ++a < c;) {
            ...
            for (var l = -1, s = u.length; ++l < s;)
                (i = u[l]) ? (t.push(e[l] = r = n.call(u.parentNode, i.__data__, l, a)), r.__data__ = i.__data__) : t.push(null)
        }
        return _(o)
    ...
    var ic,
        ...
        cc,
        lc,
        sc = fa[p(fa, "requestAnimationFrame")] || function(n) {
            setTimeout(n, 17)
        };
    ...
    Yl.call = La.call, Yl.empty = La.empty, Yl.node = La.node, Yl.size = La.size, oa.transition = function(n) {
        ...
        for (var o = -1, a = this.length; ++o < a;) {
            ...
            for (var c = this[o], l = -1, s = c.length; ++l < s;)
                (e = c[l]) && (r = n.call(e, e.__data__, l, o)) ? ("__data__" in e && (r.__data__ = e.__data__), Ko(r, l, u, e.__transition__[u]), t.push(r)) : t.push(null)
        }
        return Jo(i, u)
        ...
        for (var n, t, r, e, u = this.id, i = ++Zl, o = [], a = 0, c = this.length; c > a; a++) {
            ...
            for (var t = this[a], l = 0, s = t.length; s > l; l++)
                (r = t[l]) && (e = Object.create(r.__transition__[u]), e.delay += e.duration, Ko(r, l, i, e)), n.push(r)
        }
        return Jo(o, i)
